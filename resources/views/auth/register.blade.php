                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input id="shop_name" type="text" placeholder="Enter Shop Name" class="form-control @error('shop_name') is-invalid @enderror" name="shop_name" value="{{ old('shop_name') }}" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <select class="role form-control @error('rol_id') is-invalid @enderror" name="role_id" required>
                                <option></option>
