...
{{--            @include('layouts.backend.home-component.home-component')--}}
            <div class="card-body">
                <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target=".create">Create New Service</button>
                ...
                <table class="table table-bordered table-hover" data-form="deleteForm">
                    ...
                    @foreach ($data as $row)
                        <tr style="text-align: center">
                            ...
                            <td>{{$row->serviceCreatedBy['name']}}</td>
                            <td>{{$row->updated_at}}</td>
                            <td>{{$row->serviceUpdatedBy['name']}}</td>
                            <td class="td-actions">
...
@include('layouts.backend.services.create-modal')
