      ...
      <div class="row">
        {{-- <div class="col-md-8"> --}}
          <div class="card">
            ...
            <div class="card-body">
                <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target=".client-create">Create New Client</button>
                    ...
                    @foreach ($data as $row)
                        <tr style="text-align: center">
                            ...
                            <td>
                                ...
                                <img style="height: 12em" class="img-fluid" src="{{asset('clients/'.$row->image)}}" alt="">
                            </td>
                            <td>{{$row->created_at}}</td>
                            <td>{{$row->clientCreatedBy['name']}}</td>
                            <td>{{$row->updated_at}}</td>
                            <td>{{$row->clientUpdatedBy['name']}}</td>
                            <td class="td-actions">
...
@include('layouts.backend.client-team.delete-modal')
@include('layouts.backend.client-team.client-create-modal')
