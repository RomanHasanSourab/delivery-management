    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Create Rate Info</h5>
            <button style="color: white" type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          </div>


        <div class="modal-body">
            <form action="{{route('admin-rate-info.store')}}" method="POST">
                @csrf
                    <div class="row">
                    {{-- <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="title" class="form-control" id="exampleFormControlTextarea1" rows="5" spellcheck="false" required></textarea>
                        </div>
                    </div>
                    </div>
