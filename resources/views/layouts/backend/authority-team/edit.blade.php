        ...
        {{-- <div class="col-md-8"> --}}
          <div class="card">
            <div class="card-header card-header-info">
              <h4 class="card-title">Authority Team</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('authority-teams.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <br>
                    <br>
                        ...
                        <a class="btn btn-danger pull-right" href="{{route('authority-teams.index')}}">Back</a>
