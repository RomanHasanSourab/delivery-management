          ...
          {{-- <div class="col-md-8"> --}}
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a class="btn btn-danger pull-right" href="{{route('agents.index')}}">Back to AGENTS List</a>
              {{-- @endif --}}
                  ...
                  <table class="table table-bordered" class="display nowrap" id="manage-agents-admin"  width="100%">
                      <thead>
