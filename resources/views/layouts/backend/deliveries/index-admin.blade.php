          ...
          <div class="card">
            <div class="card-body">
                <div class="float-left">
                    <a class="btn btn-primary pull-right" href="{{route('all.deliveries')}}">All Deliveries</a>
                </div>
                ...
                <table class="table table-bordered" class="display nowrap" id="get-admin-deliveries"  width="100%">
                    <thead>
