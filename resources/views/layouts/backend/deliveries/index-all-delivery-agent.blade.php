...
{{--                            <button class="btn btn-danger" onclick="get_cancel_id()">Cancel</button>--}}
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target=".cancel" onclick="get_cancel_id()">Cancel</button>
{{--                        </form>--}}
                    </li>
                    <li style="list-style: none;" class="nav-item">
                    ...
                    <li style="list-style: none;" class="nav-item">
                        <form action="{{route('delivery.invoice.agent')}}" method="POST">
                            @csrf
...
{{--                            <input type="text" name="user_id" value="{{$id}}" hidden>--}}
                ...
                <table class="table table-bordered" class="display nowrap" id="get-agent-deliveries-all"  width="100%">
                    <thead>
    ...
    <div class="modal fade cancel" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        {{-- <div class="modal-dialog modal-lg modal-dialog-centered"> --}}
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
...
<script>
    $(function() {
        ...
        $('#get-agent-deliveries-all').DataTable({
            processing: true,
            serverSide: true,
            // responsive: true,
            scrollX: true,
            // paging: false,
            scrollY: "500px",
            ajax: '{{ url('get-all-deliveries-agent') }}',
            columns: [
