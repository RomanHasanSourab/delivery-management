          ...
          <div class="card">
            <div class="card-body">
                <div class="float-left">
                    <a class="btn btn-primary pull-right" href="{{route('deliveries-admin')}}">Delivery Requests</a>
                </div>
                ...
                <table class="table table-bordered" class="display nowrap" id="get-admin-deliveries-all"  width="100%">
                    <thead>
...
<script>
    $(function() {
        ...
        $('#get-admin-deliveries-all').DataTable({
            processing: true,
            serverSide: true,
            // responsive: true,
            scrollX: true,
            // paging: false,
            scrollY: "500px",
            ajax: '{{ url('get-all-deliveries-admin') }}',
            columns: [
