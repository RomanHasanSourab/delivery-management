    ...
    <table class="table table-bordered">
      <tbody>
        <tr>
          ...
          <td style="font-weight: 500">
            @php
                $dateTime= strtotime($delivery->created_at);
        ...
        <tr>
            ...
            <td style="font-weight: 500">
                @if($delivery->deliveryFrom)
                {{$delivery->deliveryFrom->title}}
                @endif
            </td>
          </tr>
      ...
      <a id="printPageButton" class="btn btn-rose btn-link" href="{{route('deliveries.info.print', $delivery->id)}}">
        Print Only Delivery Information
      </a>
    </div>
